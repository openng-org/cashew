...
## [5.3.0](https://github.com/openng/cashew/compare/v5.1.0...v5.3.0) (2025-08-21)


### Features

* add `withConfig` for customizable HTTP  configuration and fix config only setup ([9cc0a11](https://github.com/openng/cashew/commit/9cc0a11fd711099ebb749df45c687cae4f8f8454))
